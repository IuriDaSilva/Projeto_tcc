     ...
     <main class="full-box main-container">
      ...
      <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <form method="POST" action="processa.php" class="form-neon" autocomplete="off">
                    <fieldset>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="msg-nome" id="msg-nome" maxlength="70">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="msg-email" id="msg-email" maxlength="70">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="info_telefone" class="bmd-label-floating">Telefone</label>
                                        <input type="text" class="form-control" name="msg-telefone" id="msg-telefone" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="info_descricao" class="bmd-label-floating">Descrição do problema ou melhoria</label>
                                        <input type="text" class="form-control" name="msg-desc" id="msg-desc" maxlength="250">
                                    </div>
                                </div>
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        <label for="info_mensagem" class="bmd-label-floating">Mensagem</label>
                                        <input type="text" class="form-control" name="mensagem" id="mensagem" maxlength="250">
                                    </div>
                                </div>
                            </div>
                        </div>
